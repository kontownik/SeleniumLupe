...
public class PublicReportGridPage extends LoadableComponent<PublicReportGridPage> {

    private WebDriver driver;
    private static final String baseUrl = PageLoad.getProjectUrl()+"/mcity/incidents/list";
    ...
    public PublicReportGridPage(WebDriver driver) {
    ...
    protected void isLoaded() throws Error {
        ...
        if(!PageLoad.elementsAreDisplayedEnabled(driver, elementList)) {
            throw new Error("ERROR: Strona grida Zgloszen w czesci publicznej '/mcity/incidents/list', nie wszystkie elementy sa widoczne i dostepne");
        }
        PageLoad.hideCookieWindow(driver,"//*[@class=\"cb-enable\"]");

        System.out.println("INFO: Udalo sie zaladowac PublicReportGridPage ("+driver.getCurrentUrl()+")");
    }
